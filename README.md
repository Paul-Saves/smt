...
# Usage
For examples demonstrating how to use SMT, you can take a look at the [tutorial notebook](https://github.com/SMTorg/smt/tree/master/tutorial) or go to the 'smt/examples' folder.
